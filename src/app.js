...

{
  ...
  subscriber.subscribe('paragraph-change', termHint.dismiss);
  ...
  subscriber.subscribe('paragraph-dec', termHint.dismiss);
  subscriber.subscribe('paragraph-inc', termHint.dismiss);
